...
class CommentSeeder extends Seeder
{
    public function run()
    {
        DB::table('comments')->insert([
            ...
            ['product_id'=>2, 'user_id'=>2, 'star'=>'3', 'content'=>'Sản phẩm khá ổn. Đi êm chân. Khả năng có lương lại ủng hộ shop đôi nữa. Giao hàng rất nhanh. 10h hôm trước đặt. 5h chiều hôm sau đã giao rồi.', 'created_at' => date("Y-m-d H:i:s")],
